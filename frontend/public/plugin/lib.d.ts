/*
 * es2020(no intl) + es2021.promise + es2021.string + es2022.array + es2022.string + es2022.object
 *
 * Note that `toLocaleString`, `toLocaleTimeString`, `toLocaleDateString` won't accept any arguments
 */
...
interface String {
	/**
	 * Determines whether two strings are equivalent in the current or specified locale. (Intl isn't support now)
	 * @param that String to compare to target string
	 */
	localeCompare(that: string): number;
}
...
interface Number {
	/**
	 * Converts a number to a string by using the current or specified locale. (Intl isn't support now)
	 */
	toLocaleString(): string;
}
...
interface Date {
	/**
	 * Converts a date and time to a string by using the current or specified locale. (Intl isn't support now)
	 */
	toLocaleString(): string;
	/**
	 * Converts a date to a string by using the current or specified locale. (Intl isn't support now)
	 */
	toLocaleDateString(): string;

	/**
	 * Converts a time to a string by using the current or specified locale. (Intl isn't support now)
	 */
	toLocaleTimeString(): string;
}
...
interface BigInt {
	...
	/** Returns a string representation appropriate to the host environment's current locale. (Intl isn't support now) */
	toLocaleString(): string;
